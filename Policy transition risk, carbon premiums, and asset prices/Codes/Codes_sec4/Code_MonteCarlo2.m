...
% simulation.div1(:,1) =         temp_dif_state.*temp_dif_temperature.*div1_s1(temp_index_state,temp_index_temperature,simulation.Y(1,1),simulation.X(1,1),simulation.B(1,1))...
%             +(1-temp_dif_state).*(1-temp_dif_temperature).*div1_s1(temp_index_state-1,temp_index_temperature-1,simulation.Y(1,1),simulation.X(1,1),simulation.B(1,1))...
%             +(1-temp_dif_state).*temp_dif_temperature.*div1_s1(temp_index_state-1,temp_index_temperature,simulation.Y(1,1),simulation.X(1,1),simulation.B(1,1))...
%             +temp_dif_state.*(1-temp_dif_temperature).*div1_s1(temp_index_state,temp_index_temperature-1,simulation.Y(1,1),simulation.X(1,1),simulation.B(1,1));
% 
% simulation.div2(:,1) =         temp_dif_state.*temp_dif_temperature.*div2_s1(temp_index_state,temp_index_temperature,simulation.Y(1,1),simulation.X(1,1),simulation.B(1,1))...
%             +(1-temp_dif_state).*(1-temp_dif_temperature).*div2_s1(temp_index_state-1,temp_index_temperature-1,simulation.Y(1,1),simulation.X(1,1),simulation.B(1,1))...
%             +(1-temp_dif_state).*temp_dif_temperature.*div2_s1(temp_index_state-1,temp_index_temperature,simulation.Y(1,1),simulation.X(1,1),simulation.B(1,1))...
%             +temp_dif_state.*(1-temp_dif_temperature).*div2_s1(temp_index_state,temp_index_temperature-1,simulation.Y(1,1),simulation.X(1,1),simulation.B(1,1));
...
% simulation.div1(temp_counter,temp_index_t) =         temp_dif_state.*temp_dif_temperature.*div1_s1(temp_index_state,temp_index_temperature,simulation.Y(temp_counter,temp_index_t),simulation.X(temp_counter,temp_index_t),simulation.B(temp_counter,temp_index_t))...
%             +(1-temp_dif_state).*(1-temp_dif_temperature).*div1_s1(temp_index_state,temp_index_temperature,simulation.Y(temp_counter,temp_index_t),simulation.X(temp_counter,temp_index_t),simulation.B(temp_counter,temp_index_t))...
%             +(1-temp_dif_state).*temp_dif_temperature.*div1_s1(temp_index_state,temp_index_temperature,simulation.Y(temp_counter,temp_index_t),simulation.X(temp_counter,temp_index_t),simulation.B(temp_counter,temp_index_t))...
%             +temp_dif_state.*(1-temp_dif_temperature).*div1_s1(temp_index_state,temp_index_temperature,simulation.Y(temp_counter,temp_index_t),simulation.X(temp_counter,temp_index_t),simulation.B(temp_counter,temp_index_t));
% 
% simulation.div2(temp_counter,temp_index_t) =         temp_dif_state.*temp_dif_temperature.*div2_s1(temp_index_state,temp_index_temperature,simulation.Y(temp_counter,temp_index_t),simulation.X(temp_counter,temp_index_t),simulation.B(temp_counter,temp_index_t))...
%             +(1-temp_dif_state).*(1-temp_dif_temperature).*div2_s1(temp_index_state,temp_index_temperature,simulation.Y(temp_counter,temp_index_t),simulation.X(temp_counter,temp_index_t),simulation.B(temp_counter,temp_index_t))...
%             +(1-temp_dif_state).*temp_dif_temperature.*div2_s1(temp_index_state,temp_index_temperature,simulation.Y(temp_counter,temp_index_t),simulation.X(temp_counter,temp_index_t),simulation.B(temp_counter,temp_index_t))...
%             +temp_dif_state.*(1-temp_dif_temperature).*div2_s1(temp_index_state,temp_index_temperature,simulation.Y(temp_counter,temp_index_t),simulation.X(temp_counter,temp_index_t),simulation.B(temp_counter,temp_index_t));
