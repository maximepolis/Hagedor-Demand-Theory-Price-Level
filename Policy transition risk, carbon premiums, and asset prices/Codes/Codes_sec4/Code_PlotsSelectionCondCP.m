...
simulation.cp=simulation.ep2-simulation.ep1;
z=(simulation.cp<0.01);
simulation.cp(simulation.cp<0.01)=NaN;
simulation.T(isnan(simulation.cp))=NaN;
simulation.S(isnan(simulation.cp))=NaN;
simulation.tax(isnan(simulation.cp))=NaN;
simulation.Emissions(isnan(simulation.cp))=NaN;
simulation.rf(isnan(simulation.cp))=NaN;
simulation.ep1(isnan(simulation.cp))=NaN;
simulation.ep2(isnan(simulation.cp))=NaN;
simulation.Y(isnan(simulation.cp))=NaN;
simulation.X(isnan(simulation.cp))=NaN;
simulation.B(isnan(simulation.cp))=NaN;
simulation.Output(isnan(simulation.cp))=NaN;
simulation.netemissions(isnan(simulation.cp))=NaN;
simulation.pi_energy(isnan(simulation.cp))=NaN;
