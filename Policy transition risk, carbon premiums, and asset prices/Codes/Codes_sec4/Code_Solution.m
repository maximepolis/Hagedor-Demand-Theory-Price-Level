...
for temp_counter_T=time.number:-1:1
    ...
    if strcmp(Business_as_usual,'on')==1
        ...
        if strcmp(Policy,'on')==1
            save([save_data_at, 'Solution_policy\Z1_solution_', num2str(temp_counter_T)], 'V','pi_energy_s1','scc_s1','d_s1','pi_s1','mu1_s1','mu2_s1','ep1_s1','ep2_s1', 'pdr1_s1', 'pdr2_s1', 'rf_s1', 'r_s1', 'i1_s1', 'i2_s1','g1_s1','g2_s1','f1_s1','f2_s1', 'c_s1', 'tax_s1', 'Q1_s1', 'Q2_s1','D1', 'D2', 'div1_s1', 'div2_s1','-v6');
        else
