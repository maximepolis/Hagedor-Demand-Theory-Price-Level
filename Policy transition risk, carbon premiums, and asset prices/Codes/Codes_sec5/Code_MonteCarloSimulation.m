...
for temp_index_t=2:time.number
    ...
    for  temp_counter=1:simulation.number
        ...
        %% Green Dividends
        simulation.div1(temp_counter,temp_index_t)=simulation.div1(temp_counter,temp_index_t-1)*exp(calib.phi*simulation.D1mu(temp_counter,temp_index_t-1)*time.delta...
        ...
        %% Brown Dividends
        simulation.div2(temp_counter,temp_index_t)=simulation.div2(temp_counter,temp_index_t-1)*exp(calib.phi*simulation.D2mu(temp_counter,temp_index_t-1)*time.delta...
