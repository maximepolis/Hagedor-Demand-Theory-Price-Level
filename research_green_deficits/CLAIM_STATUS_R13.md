...
**Status of the evidence.** No number was recomputed for this file. The
two-asset economy remains **UNCERTIFIED**: Track A has not returned a Gate 11
verdict, and no two-asset quantity below may be presented as established.
...
| 18 (deficit ratchet) | **IE** (R10 row 20) | **NI** (timing/ratchet split) / **QV** (sign reversal at matched terminal debt) / **WP** (timing-frontier location, pending the $\rho=0.80$ re-run) | `main_deficit_decomposition` run 2026-08-06: $C2{-}C1$ reverses the sign at matched terminal debt; 34/66 timing/ratchet split; `main_timing_frontier` validates 1.41 years as the *joint* frontier |

One row moves *upward* out of **WP**: the item-18 tax-timing leg, on the matched-terminal-debt run (`main_deficit_decomposition`, 2026-08-06) — sign only; the *location* of the timing frontier stays **WP** pending the $\rho=0.80$ re-run. No two-asset status changed.
