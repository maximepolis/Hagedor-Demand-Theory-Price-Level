...
%  12a. main_transition_ordering    finite-horizon operativeness
%                                   of the instrument ordering
%                                   (post-processing, no solve)   [MATLAB]
%  12b. main_transition_deficit     deficit-financed DTPL path    [MATLAB]
%  12c. main_transition_deficit_ladder  financing-timing frontier
%                                   and the critical phase-in     [MATLAB]
%  12d. main_twoasset_kv_transition KV announcement path +
%                                   transition-inclusive
%                                   incidence (4 kernel gates)    [MATLAB]
%  12e. main_validation_mobility    wealth-mobility diagnostics   [MATLAB]
...
%   16. decompose_tax_elasticity    dS/dtau by wealth group +
%                                   sign sweep (abar, risk,
%                                   sigma, beta, instrument)      [MATLAB]
%   17. export_paper_numbers        paper/numbers_auto.tex        [MATLAB]
...
stages = { ...
    ...
    'main_transition_ordering',        'matlab'; ...
    'main_transition_deficit',         'matlab'; ...
    'main_transition_deficit_ladder',  'matlab'; ...
    'main_twoasset_kv_transition',     'matlab'; ...
    'main_validation_mobility',        'matlab'; ...
    'verify_mu_neutrality',            'matlab'; ...
    'sensitivity_climate_discipline',  'matlab'; ...
    'verify_transition_ssj',           'matlab'; ...
    'decompose_tax_elasticity',        'matlab'; ...
    'welfare_incidence_deciles',       'matlab'; ...
    'verify_egm_vs_vfi',               'matlab'; ...
    'wealth_concentration_fit',        'matlab'; ...
    'verify_grid_convergence',         'matlab'; ...
