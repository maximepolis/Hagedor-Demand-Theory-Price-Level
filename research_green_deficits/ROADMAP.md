...
| U5 | Debt maturity — **machinery DONE** (`debt_maturity_revaluation.m` + `main_project_maturity.m`: level-jump-equivalence result, indexation/holder bounds nu^M, duration under accommodation, q_g implementation-efficiency sweep, PFig10-11). Numbers pending run | run pending | calibrated results |
